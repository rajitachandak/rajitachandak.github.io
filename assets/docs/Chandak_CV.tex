...
\address{Institute of Mathematics, EPFL}{}{September 2025}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
{\textbf{Dissertation:} \textit{Adaptive nonparametric statistical theory and implementation}
  \\
  \textbf{Advisor: }\color{blue}\href{https://mdcattaneo.github.io}{Matias Cattaneo}\color{black}}
...
{}
{}
{with \color{blue}\href{https://mdcattaneo.github.io}{Matias Cattaneo}\color{black},
...
{}
{with
  \color{blue}\href{https://mdcattaneo.github.io}{Matias Cattaneo }\color{black} and
...
\cventry{2024-Present}{Institute of Mathematics}{Lecturer (Charg\'ee de cours)}
{Lausanne, CH}{EPFL}{
...
\cventry{2020-2024}{ORFE}{Graduate Assistant in Instruction}{Princeton, USA}{Princeton University}{
...
\vspace{-0.3cm}
\section{Service}
\cventry{}{Primary advisor}{Masters student supervision}{2024--2026}
{}
...
\begin{cvcolumns}
  ...
  \cvcolumn{}{\textbf{French:} Intermediate (CEFR B1)}
\end{cvcolumns}
