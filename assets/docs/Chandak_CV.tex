...
{\textbf{Dissertation:} \textit{Adaptive nonparametric statistical theory and implementation}
  \\
  \textbf{Advisor: }\color{blue}\href{https://cattaneo.princeton.edu}{Prof. Matias Cattaneo}\color{black}}
...
{Brown University}{Providence, RI, USA}{}{ Honors Thesis: \textit{Energy-aware optimization of scalable load balancing
  ...
  {Prof. Kavita Ramanan}\color{black}}  % arguments 3 to 6 can be left empty
...
\cventry{2020-2024}{ORFE}{Graduate Assistant in Instruction}{Princeton, NJ}{Princeton University}{
